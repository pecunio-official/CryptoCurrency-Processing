...
class Cryptobox {
	...
	*/
	 ...
	 *
	 * It generates url with your paramenters to ctrlholdings.com payment gateway.
	 * Using this url you can get bitcoin/altcoin payment box values in JSON format and use it on html page with Jquery/Ajax.
	 * See instruction https://ctrlholdings.com/bitcoin-payment-gateway-api.html#p8
	 *  
	 * JSON Values Example -
	 * Payment not received - https://coins.ctrlholdings.com/b/20/c/Bitcoin/p/20AAvZCcgBitcoin77BTCPUB0xyyeKkxMUmeTJRWj7IZrbJ0oL/a/0/au/2.21/pe/NOEXPIRY/l/en/o/invoice22/u/83412313__3bccb54769/us/COOKIE/j/1/d/ODIuMTEuOTQuMTIx/h/e889b9a07493ee96a479e471a892ae2e   
	 * Payment received successfully - https://coins.ctrlholdings.com/b/20/c/Bitcoin/p/20AAvZCcgBitcoin77BTCPUB0xyyeKkxMUmeTJRWj7IZrbJ0oL/a/0/au/0.1/pe/NOEXPIRY/l/en/o/invoice1/u/demo/us/MANUAL/j/1/d/ODIuMTEuOTQuMTIx/h/ac7733d264421c8410a218548b2d2a2a
	 * 
	...
	public function cryptobox_json_url()
	{
	    ...
	    $url = "https://coins.ctrlholdings.com";
	...
	public function get_json_values()
	{
		...
		// security; validate data sent by ctrlholdings.com
		$f = false;
		if ($res)
		{
	...
	*/
	...
	private function check_payment_live()
	{
		...
		$ch = curl_init( "https://coins.ctrlholdings.com/result.php" );
		curl_setopt( $ch, CURLOPT_SSL_VERIFYPEER, FALSE);
				...
				$res["private_key"] && preg_replace('/[^A-Za-z0-9]/', '', $res["private_key"]) == $res["private_key"] && $res["private_key"] == $this->private_key)
		{
			 ...
			 *  Read more - https://ctrlholdings.com/api-php.html#ipn
			 */
